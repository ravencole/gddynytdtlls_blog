...
function NavAnimation() {
    ...
    var animationCallback = function animationCallback(e) {
    ...
    var addAnimation = function addAnimation(_) {
        window.addEventListener('scroll', animationCallback);
    };

    var destroyAnimation = function destroyAnimation(_) {
