...
tinymce.init({
    ...
    toolbar: ['bold italic underline strikethrough', 'alignleft aligncenter alignright alignjustify', 'formatselect', 'bullist numlist', 'blockquote code emoticons', 'link image', 'fullscreen'].join(' | '),
